...
def calculate_attack_chains(analyzed_data):
    ...
    try:
        ...
        MITRE_TECHNIQUES = {
            # Entry → Pivot
            ("FTP",    "SSH"):          {"mitre_id": "T1021.004", "technique": "Remote Services: SSH",              "category": "credential_reuse", "difficulty": 3},
            ("FTP",    "SMB"):          {"mitre_id": "T1021.002", "technique": "Remote Services: SMB",              "category": "credential_reuse", "difficulty": 4},
            ("FTP",    "RPC"):          {"mitre_id": "T1021",     "technique": "Remote Services",                "category": "credential_reuse", "difficulty": 5},
            ("FTP",    "NetBIOS-SSN"):  {"mitre_id": "T1018",     "technique": "Remote System Discovery",     "category": "discovery",        "difficulty": 3},
            ("HTTP",   "SSH"):          {"mitre_id": "T1505.003", "technique": "Web Shell",                     "category": "exploitation",     "difficulty": 4},
            ("HTTP",   "SMB"):          {"mitre_id": "T1210",     "technique": "Exploitation of Remote Services", "category": "exploitation", "difficulty": 5},
            ("HTTP",   "RPC"):          {"mitre_id": "T1059",     "technique": "Command Execution",            "category": "exploitation",     "difficulty": 6},
            ("HTTPS",  "SSH"):          {"mitre_id": "T1505.003", "technique": "Web Shell",                     "category": "exploitation",     "difficulty": 5},
            ("HTTPS",  "SMB"):          {"mitre_id": "T1210",     "technique": "Exploitation of Remote Services", "category": "exploitation", "difficulty": 5},
            ("RDP",    "SMB"):          {"mitre_id": "T1021.001", "technique": "Remote Desktop Protocol",      "category": "credential_reuse", "difficulty": 2},
            ("RDP",    "SSH"):          {"mitre_id": "T1078",     "technique": "Valid Accounts",               "category": "credential_reuse", "difficulty": 3},
            ("VNC",    "SSH"):          {"mitre_id": "T1021.005", "technique": "Remote Services: VNC",          "category": "credential_reuse", "difficulty": 3},
            ("VNC",    "SMB"):          {"mitre_id": "T1021.005", "technique": "Remote Services: VNC",          "category": "credential_reuse", "difficulty": 3},
            ("Telnet", "SSH"):          {"mitre_id": "T1557",     "technique": "Adversary-in-the-Middle",      "category": "credential_theft", "difficulty": 2},
            ("Telnet", "SMB"):          {"mitre_id": "T1557",     "technique": "Adversary-in-the-Middle",      "category": "credential_theft", "difficulty": 2},
            # Entry → Target (direct attacks)
            ("FTP",    "MySQL"):        {"mitre_id": "T1078",     "technique": "Valid Accounts",               "category": "credential_reuse", "difficulty": 3},
            ("FTP",    "MSSQL"):        {"mitre_id": "T1078",     "technique": "Valid Accounts",               "category": "credential_reuse", "difficulty": 3},
            ("FTP",    "PostgreSQL"):   {"mitre_id": "T1078",     "technique": "Valid Accounts",               "category": "credential_reuse", "difficulty": 3},
            ("FTP",    "DNS"):          {"mitre_id": "T1048",     "technique": "Exfiltration Over Alt Protocol", "category": "exfiltration",  "difficulty": 5},
            ("HTTP",   "MySQL"):        {"mitre_id": "T1190",     "technique": "Exploit Public-Facing App",    "category": "exploitation",     "difficulty": 4},
            ("HTTP",   "MSSQL"):        {"mitre_id": "T1190",     "technique": "Exploit Public-Facing App",    "category": "exploitation",     "difficulty": 4},
            ("HTTP",   "PostgreSQL"):   {"mitre_id": "T1190",     "technique": "Exploit Public-Facing App",    "category": "exploitation",     "difficulty": 4},
            ("HTTP",   "DNS"):          {"mitre_id": "T1572",     "technique": "Protocol Tunneling",           "category": "exfiltration",     "difficulty": 6},
            ("HTTPS",  "MySQL"):        {"mitre_id": "T1190",     "technique": "Exploit Public-Facing App",    "category": "exploitation",     "difficulty": 5},
            ("HTTPS",  "MSSQL"):        {"mitre_id": "T1190",     "technique": "Exploit Public-Facing App",    "category": "exploitation",     "difficulty": 5},
            ("HTTPS",  "PostgreSQL"):   {"mitre_id": "T1190",     "technique": "Exploit Public-Facing App",    "category": "exploitation",     "difficulty": 5},
            ("RDP",    "MySQL"):        {"mitre_id": "T1021.001", "technique": "Remote Desktop Protocol",      "category": "credential_reuse", "difficulty": 2},
            ("RDP",    "MSSQL"):        {"mitre_id": "T1021.001", "technique": "Remote Desktop Protocol",      "category": "credential_reuse", "difficulty": 2},
            # Pivot → Pivot
            ("SSH",    "SMB"):          {"mitre_id": "T1572",     "technique": "Protocol Tunneling",           "category": "tunneling",        "difficulty": 4},
            ("SMB",    "RPC"):          {"mitre_id": "T1210",     "technique": "Exploitation of Remote Services", "category": "exploitation", "difficulty": 5},
            ("SSH",    "RPC"):          {"mitre_id": "T1572",     "technique": "Protocol Tunneling",           "category": "tunneling",        "difficulty": 4},
            ("NetBIOS-SSN", "SMB"):     {"mitre_id": "T1018",     "technique": "Remote System Discovery",     "category": "discovery",        "difficulty": 2},
            # Pivot → Target
            ("SSH",    "MySQL"):        {"mitre_id": "T1572",     "technique": "Protocol Tunneling",           "category": "tunneling",        "difficulty": 3},
            ("SSH",    "MSSQL"):        {"mitre_id": "T1572",     "technique": "Protocol Tunneling",           "category": "tunneling",        "difficulty": 3},
            ("SSH",    "PostgreSQL"):   {"mitre_id": "T1572",     "technique": "Protocol Tunneling",           "category": "tunneling",        "difficulty": 3},
            ("SSH",    "DNS"):          {"mitre_id": "T1048",     "technique": "Exfiltration Over Alt Protocol", "category": "exfiltration",  "difficulty": 5},
            ("SMB",    "MySQL"):        {"mitre_id": "T1570",     "technique": "Lateral Tool Transfer",        "category": "credential_reuse", "difficulty": 4},
            ("SMB",    "MSSQL"):        {"mitre_id": "T1570",     "technique": "Lateral Tool Transfer",        "category": "credential_reuse", "difficulty": 4},
            ("SMB",    "PostgreSQL"):   {"mitre_id": "T1570",     "technique": "Lateral Tool Transfer",        "category": "credential_reuse", "difficulty": 4},
            ("SMB",    "DNS"):          {"mitre_id": "T1048",     "technique": "Exfiltration Over Alt Protocol", "category": "exfiltration",  "difficulty": 5},
            ("RPC",    "MSSQL"):        {"mitre_id": "T1210",     "technique": "Exploitation of Remote Services", "category": "exploitation", "difficulty": 6},
            ("RPC",    "MySQL"):        {"mitre_id": "T1210",     "technique": "Exploitation of Remote Services", "category": "exploitation", "difficulty": 6},
        }
        ...
        def _add_chain(from_svc, to_svc, chain_type, risk_score):
            """Add a chain if not already present. Enriched with MITRE ATT&CK data."""
            ...
            mitre_info = MITRE_TECHNIQUES.get(
                (from_base, to_base),
                {"mitre_id": "T1210", "technique": "Exploitation of Remote Services",
                 "category": "exploitation", "difficulty": 5}
            )

            # Adjust risk: lower difficulty = easier attack = higher risk
            adjusted_risk = round(min(risk_score + (7 - mitre_info["difficulty"]) * 0.2, 10.0), 1)
            ...
            chains.append({
                ...
                "difficulty": mitre_info["difficulty"]
            })
