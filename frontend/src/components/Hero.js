    ...
    <div className="relative min-h-screen flex items-center justify-center bg-transparent">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <div className="flex flex-col items-center justify-center mb-16 px-4">
          <h1 className="text-4xl md:text-7xl lg:text-[7rem] font-black text-white uppercase tracking-tighter leading-[1.1] text-center drop-shadow-2xl max-w-screen-xl">
            NET_SCAN : <br className="hidden md:block" /><span className="text-gray-400 md:text-6xl lg:text-[5rem] tracking-tight">Graph-Intelligent Attack Path Analyzer</span>
          </h1>
        </div>

        <div className="flex gap-6 justify-center mt-10 md:mt-16">
