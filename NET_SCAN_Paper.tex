...
The experimental testbed comprised eight network segments accessible from the scanning host, each representing a fundamentally different network archetype. Figs.~\ref{fig:ipconfig} and \ref{fig:ipconfig2} confirm the network adapter configurations of the host machines used across all scanning sessions.
